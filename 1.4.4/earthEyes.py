...
fig3.savefig('1.4.4/earths_as_eyes.png')

print(earth_img.size)
print(earth_small.size)
print(earth_img.size[1])
earth_small.save('1.4.4/smallEarth.png')